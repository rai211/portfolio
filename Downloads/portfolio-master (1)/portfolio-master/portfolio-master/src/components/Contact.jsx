    ...
    <section className="border-b border-neutral-800 pb-24">
      ...
      <div className="w-5/6 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        ...
        <motion.div
          ...
          className="relative bg-neutral-900/80 border border-neutral-800 rounded-xl p-6 sm:p-10 flex flex-col gap-8 overflow-hidden"
        >
          <div className="absolute -top-10 -left-10 w-40 h-40 bg-purple-600/10 rounded-full blur-2xl pointer-events-none" />

          <div>
            <p className="text-purple-400 text-xs lg:text-sm tracking-widest uppercase font-medium mb-1">Contact</p>
          ...
          <div className="flex flex-col gap-3">
           ...
           <a href={`tel:${CONTACT.phoneNo}`}
            ...
            >
              ...
              <span className="text-sm lg:text-base tracking-wide">{CONTACT.phoneNo}</span>
            </a>
            ...
            >
              ...
              <span className="text-sm lg:text-base tracking-wide">{CONTACT.email}</span>
            </a>
          </div>
          ...
          {/* Social icons */}
          <div>
            <p className="text-neutral-600 text-xs lg:text-sm tracking-widest uppercase mb-4">Find me on</p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            ...
            <span className="text-neutral-500 text-xs lg:text-sm tracking-wide">Open to new opportunities</span>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: 60 }}
          transition={{ duration: 0.6 }}
          className="relative bg-neutral-900/80 border border-neutral-800 rounded-xl p-6 sm:p-10 flex flex-col overflow-hidden"
        >
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-purple-600/10 rounded-full blur-2xl pointer-events-none" />

          <div className="mb-6">
            <p className="text-purple-400 text-xs lg:text-sm tracking-widest uppercase font-medium mb-1">Message</p>
