...
const Experience = () => {
  return (
    <div className="w-5/6 mx-auto border-b border-neutral-900 pb-4 relative">

      <h1 className="my-20 text-center text-4xl">Experience</h1>

      {/* Timeline vertical line */}
      <div className="absolute left-4 lg:left-[25%] top-40 h-[86%] w-[2px] bg-neutral-800 lg:-translate-x-[50%]"></div>

      <div>
        {EXPERIENCES.map((experience, index) => (
          <div
            key={index}
            className="mb-14 flex flex-wrap items-start relative"
          >
            ...
            <motion.div
              ...
              className="w-full lg:w-[25%] pl-10 lg:pl-0 lg:pr-8 mb-2 lg:mb-0"
            >
              <p className="mb-2 text-sm lg:text-base text-neutral-400 flex flex-wrap items-center gap-x-2 gap-y-1 lg:justify-end">
            ...
            {/* Timeline Dot */}
            <div className="absolute left-4 lg:left-[25%] translate-x-[-50%] mt-2 flex items-center justify-center">
            ...
            <motion.div
              ...
              initial={{ opacity: 0, x: 100 }}
              transition={{ duration: 1 }}
              className="w-full max-w-3xl lg:w-[75%] pl-10 lg:pl-12"
            >
              <div
              ...
              >
                ...
                {Array.isArray(experience.description) ? (
                  <ul className="list-disc pl-5 space-y-2 text-neutral-400 text-sm lg:text-base">
                    {experience.description.map((point, i) => (
                      <li key={i}>{point}</li>
                    ))}
                  </ul>
                ) : (
                  <p className="mb-4 text-neutral-400 text-sm lg:text-base leading-relaxed">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {experience.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className="rounded-md bg-neutral-800 px-3 py-1 text-xs lg:text-sm font-medium text-purple-300 border border-neutral-700"
                    >
                      {tech}
                    </span>
                  ))}
