      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 pt-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <motion.span
            ...
            initial="hidden"
            animate="visible"
            className="bg-gradient-to-r from-pink-400 via-violet-400 to-purple-500 bg-clip-text text-xl lg:text-2xl tracking-tight text-transparent font-medium pb-2"
          >
          ...
          <motion.span
            ...
            initial="hidden"
            animate="visible"
            className="text-neutral-400 text-sm lg:text-base tracking-widest uppercase font-light pb-4"
          >
          ...
          <motion.p
            ...
            initial="hidden"
            animate="visible"
            className="max-w-xl py-4 font-light tracking-tight text-neutral-400 leading-relaxed text-sm lg:text-base border-l-2 border-purple-500/40 pl-4"
          >
            {HERO_CONTENT}
          </motion.p>
